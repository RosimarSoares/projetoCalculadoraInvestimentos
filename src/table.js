// contrato
// 1 - Sistema deve usar o Tailwind
// 2 - Sistema deve ter um elemento html do tipo table (com id definido) preparado e sem informações dentro
// 3 - São necessário dois arrays para a geração da tabela...
//  3.1 - Um array de dados
//  3.2 - Um array com objetos que caracterizam colunas
...
function createTableHeader(tableReference, columnsArray) {
  ...
  ["bg-blue-900", "text-slate-200", 'sticky', 'top-0'].forEach((ccClass) =>
    headerRow.classList.add(ccClass)
  );
