...
const columnsArray = [
  { columnLabel: "Mês", accessor: "month" },
  {
    ...
    format: (numberInfo) => formatCurrancyToTable(numberInfo),
  },
  {
...
function formatCurrancyToTable(value) {
  return value.toLocaleString("pt-BR", { style: "currency", currency: "BRL" });
}

function formatCurrancyToGraph(value) {
  ...
  doughnutChartReference = new Chart(finalMoneyChart, {
    ...
    data: {
      ...
      datasets: [
        {
          data: [
            formatCurrancyToGraph(finalInvestmentObject.investedAmount),
            formatCurrancyToGraph(
      ...
      datasets: [
        {
          ...
          data: returnsArray.map((investmentObject) =>
            formatCurrancyToGraph(investmentObject.investedAmount)
          ),
        ...
        },
        {
          ...
          data: returnsArray.map((investmentObject) =>
            formatCurrancyToGraph(investmentObject.interestReturns)
          ),
